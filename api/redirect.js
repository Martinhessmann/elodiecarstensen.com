export default function handler(req, res) {
  ...
  const redirectMap = {
    ...
    '/about': '/about',
    '/news': '/about',
    '/miss-ivanka-t-on-queerclub': '/about',
    '/plastic-barock': '/about',
    '/monja-morphing-muse': '/about',
    '/miriam-for-crownsproject': '/about',
    '/ari-emily': '/about',
    '/lenaig-chatel-for-pump': '/about',
    '/rebirth-for-kaltblut-magazine': '/about',
    '/bassam-allam': '/about',
    '/gaia': '/about',
    '/runa-by-beto-ruiz-alonso': '/about',
    ...
    '/the-severed-tail-piglet-dress': '/about',
    '/berlin-showroom-bei-der-paris-fashion-week': '/about',
    '/nikeata-thompson-on-greentech-festival': '/about',
    '/twisted-vorn-berlin-fashion-hub-design-academy': '/about',
    '/echoes-of-promised-safety': '/gallery/absence-of-promised-safety',
    '/imprint/': '/about',
    '/news/': '/about',
    '/preview/': '/',
    '/newsletter/': '/about',
